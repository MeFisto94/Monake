...
selector( "slider.right.button", "quake" ) {
    text = "+"
    background = doubleGradient.clone()
    background.setColor(color(0.5, 0.75, 0.75, 0.5))
...
selector( "slider.up.button", "quake" ) {
    buttonCommands = sliderButtonCommands;
}

selector( "slider.down.button", "quake" ) {
    buttonCommands = sliderButtonCommands;
}

selector( "checkbox", "quake" ) {
...
selector( "rollup", "quake" ) {
    background = gradient.clone()  
    background.setColor(color(0.25, 0.5, 0.5, 0.5))
}

selector( "tabbedPanel", "quake" ) {
    activationColor = color(0.8, 0.9, 1, 0.85f)
}

selector( "tabbedPanel.container", "quake" ) {
    background = null
}

selector( "tab.button", "quake" ) {
    background = gradient.clone()
    background.setColor(color(0.25, 0.5, 0.5, 0.5))
